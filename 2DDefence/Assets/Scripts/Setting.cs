...
public class Setting : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            if (hit.collider != null)
            {
                ...
                {
                    if (setting_Panel != null) setting_Panel.gameObject.SetActive(false);
                }
            }
            else
            {
    ...
    void ToggleSettingPanel()
    {
        if (setting_Panel != null)
        {
            ...
            bool isActive = setting_Panel.gameObject.activeSelf;
            setting_Panel.gameObject.SetActive(!isActive);
        }
    }
}
